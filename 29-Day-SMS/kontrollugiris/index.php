...
<html lang="tr">
<head>
	<title>PHP SMS GÜVENLİK KOD İLE GİRİŞ</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="ikinci.php">
					...
					<div class="wrap-input100 validate-input" data-validate="Telefon zorunludur">
						<span class="label-input100">Telefon</span>
						<input class="input100" type="text" name="telefon" placeholder="5XX XXX XX XX">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
