   ...
   function urunler ($v) {
	   ...
	   echo '<div class="col-xl-2 col-lg-2 col-md-2 m-3  uruniskelet" >
	   			<div class="row">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 p-2">
						 <a href="index.php?islem=sepeteat&id='.$urunson["id"].'" class="btn btn-dark btn-block p-2">EKLE</a>
						</div>				
				</div>	   
	   </div>';
	...
	//echo "adet : " . $deger['adet'] . "birim : ". $deger['birim']. "-" . "ad  : ". $deger['ad']. "<br>";		
			...
			$toplamtutar += $deger['birim'] * $deger['adet'];
				...
				echo '<div class="row text-center sepetaltbar p-2">
							...
							<div class="col-xl-4 col-lg-4 col-md-4"><a href="siparistamamla.php" class="btn btn-dark btn-block">SİPARİŞİ TAMAMLA</a></div>
